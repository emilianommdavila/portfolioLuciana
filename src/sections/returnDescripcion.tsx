...
function ReturnDescripcion() {
  return (
    ...
    <div className='descripcion'>
      ...
      <div id='descripcion'>Estudiante de la Tecnicatura Universitaria en Diseño y Animación Digital. Tengo 24 años y me encuentro en busca de mi primera experiencia en el área del modelado y animación 3D.</div>
